...
class PluginGestionConfig extends CommonDBTM
{
   ...
   static function showConfigForm() //formulaire de configuration du plugin
   {
      ...
      if($mode == true && !empty($config->TenantID()) || !empty($config->SageToken())){
         ...
         $resultRows = $DB->doQuery($queryRows);
      ...
      $res = $DB->doQuery("SELECT * FROM glpi_plugin_gestion_signaturedevices ORDER BY device_id");
      if ($res) {
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td class='center' style='margin-top:100px;' colspan='2'>";
   ...
   function getTabNameForItem(CommonGLPI $item, $withtemplate = 0)
   {
      ...
      if ($item->getType() == 'Config') {
         //return __("Gestion BL", "gestion");
         return __('<span class="d-flex align-items-center"><i class="fa-solid fa-file-contract me-2"></i> Gestion BL</span>', "gestion");
      }
      return '';
   }
